...
pixi add gz-math gz-math-python gz-math7 gz-math7-python libgz-math libgz-math7
# for installing globally
pixi global install gz-math gz-math-python gz-math7 gz-math7-python libgz-math libgz-math7
```
