...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gz-math-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gz-math-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add gz-math gz-math8 gz-math8-python libgz-math libgz-math8
# for installing globally
pixi global install gz-math gz-math8 gz-math8-python libgz-math libgz-math8
```
...
It is possible to list all of the versions of `gz-math` available on your platform:
...
```
pixi search gz-math --channel conda-forge
```
